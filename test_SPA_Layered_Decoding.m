...
dec_cfg = ldpcDecoderConfig(H, 'layered-bp');
...
tic
[vn_llr_app_m, cn_llr_ext_m, iter_termi_m] = SPA_Layered_Decoding_m(H_dec, Lch, cn_llr_ext_m, iter_max, termi_method);
toc

tic
[vn_llr_app_c, cn_llr_ext_c, iter_termi_c] = SPA_Layered_Decoding_c(H_dec, Lch, cn_llr_ext_c, iter_max, termi_method);
toc
